...
function Header() {
    ...
    return (
        <header>
            <div className="flex justify-between items-center bg-[#FBEBB5] mx-auto max-w-screen-2xl p-4">
            ...
            <nav
                className={`md:hidden fixed top-0 left-0 w-full h-full  z-20 transition-transform duration-300 ${isMenuOpen ? 'transform translate-x-0' : 'transform -translate-x-full'}`}
            >
